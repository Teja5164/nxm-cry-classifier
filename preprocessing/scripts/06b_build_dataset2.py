...
OUT_DIR      = str(_ROOT / 'datasets' / 'Dataset2')
...
def build_dataset(df):
    ...
    print(f"\n── Building Dataset2 (target: {TARGET_PER_CLASS}/class) ──")
    ...
    for cls in CLASSES:
        ...
        if n_avail >= TARGET_PER_CLASS:
            ...
            print(f"    → {n_avail} originals + {needed} augmented needed (up to {aug_factor}x per file)")
